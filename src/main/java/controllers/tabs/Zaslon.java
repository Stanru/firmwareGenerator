...
public class Zaslon extends AbstractTab {
    @FXML
    ...
    public String getNameFileFirmware(){
        return String.format("Заслон_%s_%d(%d)_%s.hex", devise.getName(), serialNumber, yearOfRelease, properties.getProperty("version"));
    }
}
