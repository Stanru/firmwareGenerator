...
public class Rosyanka extends AbstractTab {
    @FXML
    ...
    public String getNameFileFirmware(){
        return String.format("Росянка_%s_%d(%d)_%s.hex", devise.getName(), serialNumber, yearOfRelease, properties.getProperty("version"));
    }
}
